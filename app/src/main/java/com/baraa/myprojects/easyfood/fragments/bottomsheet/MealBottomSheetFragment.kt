package com.baraa.myprojects.easyfood.fragments.bottomsheet
...
import com.baraa.myprojects.easyfood.databinding.FragmentMealBottomSheetBinding
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        @JvmStatic fun newInstance(param1: String) = MealBottomSheetFragment().apply {
